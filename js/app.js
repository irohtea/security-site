(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-brands__slider")) new core(".slider-brands__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".slider-works__slider")) new core(".slider-works__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                prevEl: ".slider-works__button-prev",
                nextEl: ".slider-works__button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
